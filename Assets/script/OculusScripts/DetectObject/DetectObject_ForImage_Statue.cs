...
public class DetectObject_ForImage_Statue : MonoBehaviour
{
    //此腳本給四海龍王圖像、魁星爺雕像使用，不可給一般物件使用
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        if (other.gameObject.tag == "Ground")
        {
            GameObject.interactionLayers = InteractionLayerMask.GetMask("Default", "Socket", "Image_Statue");//把GameObject的layer設為Default跟Socket
